...
function handleRentCar(carId) {
    ...
    container.innerHTML = `
        <div class="rental-detail-card">
           <h3><span class="material-icons-outlined">${car.category === 'motor' ? 'two_wheeler' : 'directions_car'}</span> Detail Kendaraan</h3>

            <div class="rental-info-row">
               <span class="rental-info-label">Kendaraan</span>
